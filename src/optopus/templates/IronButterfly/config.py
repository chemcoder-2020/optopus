...
STRATEGY_PARAMS = {
    ...
    "lower_strike": config.get("STRATEGY_PARAMS", "lower_strike", raw=True),
    "middle_strike": config.get("STRATEGY_PARAMS", "middle_strike", raw=True),
    "upper_strike": config.get("STRATEGY_PARAMS", "upper_strike", raw=True),
    "strategy_side": config.get("STRATEGY_PARAMS", "strategy_side"),
